...
import linkedin from '../assets/linked_propic.jpg';
...
const About: React.FC = () => {
  ...
  const timeline = [
    ...
    { 'icon': <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path fill="#99B2F5" d="M160 64c0-35.3 28.7-64 64-64L576 0c35.3 0 64 28.7 64 64l0 288c0 35.3-28.7 64-64 64l-239.2 0c-11.8-25.5-29.9-47.5-52.4-64l99.6 0 0-32c0-17.7 14.3-32 32-32l64 0c17.7 0 32 14.3 32 32l0 32 64 0 0-288L224 64l0 49.1C205.2 102.2 183.3 96 160 96l0-32zm0 64a96 96 0 1 1 0 192 96 96 0 1 1 0-192zM133.3 352l53.3 0C260.3 352 320 411.7 320 485.3c0 14.7-11.9 26.7-26.7 26.7L26.7 512C11.9 512 0 500.1 0 485.3C0 411.7 59.7 352 133.3 352z"/></svg>,
      'text':"After graduating, I worked as a STEM tutor, where helping a student with their intro to computer science courses reignited my passion for programming and problem-solving."
    },
  ...
  'text': "I started learning web development through The Odin Project and eventually building full-stack projects like Claritea, a content creator review platform. I found myself drawn to the backend work: building APIs, designing database schemas and migrations, and implementing analytics to track user engagement across the platform",
    },
    { 'icon': <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path fill="#99B2F5" d="M64 96c0-35.3 28.7-64 64-64l384 0c35.3 0 64 28.7 64 64l0 256-64 0 0-256L128 96l0 256-64 0L64 96zM0 403.2C0 392.6 8.6 384 19.2 384l601.6 0c10.6 0 19.2 8.6 19.2 19.2c0 42.4-34.4 76.8-76.8 76.8L76.8 480C34.4 480 0 445.6 0 403.2zM281 209l-31 31 31 31c9.4 9.4 9.4 24.6 0 33.9s-24.6 9.4-33.9 0l-48-48c-9.4-9.4-9.4-24.6 0-33.9l48-48c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9zM393 175l48 48c9.4 9.4 9.4 24.6 0 33.9l-48 48c-9.4 9.4-24.6 9.4-33.9 0s-9.4-24.6 0-33.9l31-31-31-31c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0z"/></svg>,
      'text': "That curiosity led me to data engineering. I'm currently a Data Science Fellow at The Knowledge House, learning the fundamentals of data analysis and machine learning using Python and SQL."
    },
  ]
 
  return (
    <Container id="about" sx={{ minHeight: '100vh',alignItems: 'center', justifyContent: 'center', display: 'flex', }}>
    <Stack sx={{ height: 'fit-content' }}>
      <Stack flexDirection='row' width='95vw' p={isMobile ? 1 : 10} justifyContent='start' alignItems='center' gap={9} > 
      {!isMobile && (
        <React.Fragment> 
          <Box border={1} borderColor='grey.600' width="50rem">
            <Box component="img" src={linkedin} padding={2} />
              <Typography gutterBottom textAlign="center" sx={{fontSize: '1.5rem'}} > ABOUT ME </Typography> 
            <Box> 
          </Box>
          </Box>
        </React.Fragment>
      ...
      {isMobile && <Typography textAlign="center" variant='h2'  sx={{mb: 5, textWrap: 'nowrap'}}>ABOUT ME</Typography>}
      {timeline.map((step, index) => (
        <Fade in={true} timeout={(index + 1) * 1000} key={index}>
          <Stack flexDirection='row' alignItems='center' justifyContent='center' sx={{ marginBottom: '25px'}}>
            ...
            <Box className="timeline-text" sx={{ flex: 1 }}>
              <Typography variant="body2" sx={{ wordWrap: 'break-word', fontSize: '1rem' }}>
                {step.text}
              </Typography>
            </Box>
          </Stack>
